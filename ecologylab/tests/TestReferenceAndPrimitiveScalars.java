...
public class TestReferenceAndPrimitiveScalars extends ElementState {
	...
	public static void main(String[] args)
	{
		...
		try {
			t.serialize("test.xml");
			TestReferenceAndPrimitiveScalars tt = 
				(TestReferenceAndPrimitiveScalars) TranslationScope.get("test", TestReferenceAndPrimitiveScalars.class).deserialize("test.xml");
			System.out.println("---------------------\nafter:\n" + tt);
