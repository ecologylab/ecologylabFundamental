 ...
 * 
 * 
 * Copyright 1990-2007 Sun Microsystems, Inc. All Rights Reserved. DO NOT ALTER OR REMOVE COPYRIGHT
 ...
 * General Public License version 2 for more details (a copy is included at /legal/license.txt).
 * 
 * You should have received a copy of the GNU General Public License version 2 along with this work;
 * if not, write to the Free Software Foundation, Inc., 51 Franklin St, Fifth Floor, Boston, MA
 * 02110-1301 USA
 * 
 * Please contact Sun Microsystems, Inc., 4150 Network Circle, Santa Clara, CA 95054 or visit
...
/**
 * This class implements miscellaneous utility methods including those used for conversion of
 * BigIntegers to byte arrays, hexadecimal printing of byte arrays etc.
 */
public class TLVTools
{
	 ...
	 * @return true if the sequence of len bytes in a starting at aOff matches those in b starting at
	 *         bOff, false otherwise
	 */
	...
	/**
	 * Converts a sequence of bytes into a printable OID, a string of decimal digits, each separated
	 * by a ".".
	 * 
	 * @param buffer
	...
	public static short[] stringToShorts(String str)
	{
		...
		{
			res[i + 1] = (short) ((b[4 * i] << 12) | (b[4 * i + 1] << 8) | (b[4 * i + 2] << 4) | b[4 * i + 3]);
		}
		return res;
	}
	 ...
	 *          initial values
	 */
	public static void writeDataArray(PrintStream writer, String name, byte[] data)
	{
