		...
		FieldTypes, IMappable<String>, Iterable<FD>
{
	 ...
	 */
	private final HashMapArrayList<String, FD>																							fieldDescriptorsByFieldName					= new HashMapArrayList<String, FD>();

	@simpl_nowrap
	@simpl_map("field_descriptor")
	@simpl_map_key_field("name")
	private final HashMapArrayList<String, FD>																							declaredFieldDescriptorsByFieldName	= new HashMapArrayList<String, FD>();
	 ...
	 */
	private final HashMap<String, FD>																												allFieldDescriptorsByTagNames				= new HashMap<String, FD>();

	private final HashMap<Integer, FD>																											allFieldDescriptorsByTLVIds					= new HashMap<Integer, FD>();

	private FD																																				fieldDescriptorForBibTeXKey					= null;

	private final HashMap<String, FD>																												allFieldDescriptorsByBibTeXTag			= new HashMap<String, FD>();

	private final ArrayList<FD>																															attributeFieldDescriptors						= new ArrayList<FD>();

	private final ArrayList<FD>																															elementFieldDescriptors							= new ArrayList<FD>();																								;
	...
	private final ArrayList<String>																													genericTypeVariables								= new ArrayList<String>();
	...
	private final Object					SCOPE_ANNOTATION_LOCK	= new Object();
